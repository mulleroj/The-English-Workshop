...
const Flashcard: React.FC<FlashcardProps> = ({ item }) => {
  ...
  return (
    <div 
      className="relative w-full max-w-sm h-96 cursor-pointer group mx-auto select-none"
    ...
    >
      ...
      >
        ...
        <div 
          className="absolute w-full h-full bg-yellow-500 rounded-md shadow-2xl border border-yellow-600 border-b-8 border-b-yellow-700 p-8 flex flex-col items-center justify-center text-black"
          translate="no"
          style={{ 
